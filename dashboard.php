    ...
    <div class="container-fluid px-0">
        ...
        <div class="row mt-5 pt-5">
            <div class="col-md-6 px-5">
                <a href="manage_products.php" class="btn w-100 black-btn">Product Management</a>
            </div>
            <div class="col-md-6 px-5">
                <a href="add_new_product.php" class="btn w-100 black-btn">Add New Product</a>
            </div>
        </div>
        <div class="row mt-5 pt-5">
            <div class="col-md-6 px-5">
                <a href="show_products.php" class="btn w-100 black-btn">Show Products</a>
            </div>
            <div class="col-md-6 px-5">
                <a href="manage_orders.php" class="btn w-100 black-btn">Order management</a>
            </div>
        </div>
    </div>
</body>
